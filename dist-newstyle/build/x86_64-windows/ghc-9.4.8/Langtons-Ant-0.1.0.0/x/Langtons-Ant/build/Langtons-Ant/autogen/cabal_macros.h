...
/* package Langtons-Ant-0.1.0.0 */
#ifndef VERSION_Langtons_Ant
#define VERSION_Langtons_Ant "0.1.0.0"
#endif /* VERSION_Langtons_Ant */
#ifndef MIN_VERSION_Langtons_Ant
#define MIN_VERSION_Langtons_Ant(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Langtons_Ant */
...
#define CURRENT_COMPONENT_ID "Langtons-Ant-0.1.0.0-inplace-Langtons-Ant"
